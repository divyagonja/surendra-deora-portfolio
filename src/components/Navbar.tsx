    ...
    <>
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${isScrolled ? 'py-4 bg-black bg-opacity-95' : 'py-6 bg-transparent'}`}>
        <div className="container mx-auto flex justify-between items-center px-4 md:px-6">
          <Link to="/" className="text-2xl font-serif text-white font-bold">DUME</Link>
      ...
      {/* Mobile Menu */}
      <div className={`fixed inset-0 bg-black z-50 transform transition-transform duration-700 ease-in-out ${isMenuOpen ? 'translate-y-0' : 'translate-y-full'}`}>
